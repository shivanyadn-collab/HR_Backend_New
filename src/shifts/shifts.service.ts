...
export class ShiftsService {
    ...
    const shiftsWithCounts = await Promise.all(
      shifts.map(async (shift: any) => {
        ...
        return {
          ...
          departments: (shift.departmentIds || [])
            .map((id: string) => departmentMap.get(id))
            .filter(Boolean),
          designations: (shift.designationIds || [])
            .map((id: string) => designationMap.get(id))
            .filter(Boolean),
        }
      }),
    )
  ...
  async update(id: string, updateShiftDto: UpdateShiftDto) {
    ...
    const updateData: any = {
      ...
      ...(updateShiftDto.breakDuration !== undefined && {
        breakDuration: updateShiftDto.breakDuration,
      }),
      ...(updateShiftDto.shiftType !== undefined && {
        shiftType: updateShiftDto.shiftType || null,
      }),
      ...(updateShiftDto.isFlexible !== undefined && { isFlexible: updateShiftDto.isFlexible }),
      ...(updateShiftDto.employeeCount !== undefined && {
        employeeCount: updateShiftDto.employeeCount,
      }),
      ...
      ...(updateShiftDto.weekOffPattern !== undefined && {
        weekOffPattern: updateShiftDto.weekOffPattern || null,
      }),
      ...(updateShiftDto.saturdayPattern !== undefined && {
        saturdayPattern: updateShiftDto.saturdayPattern || null,
      }),
      ...(updateShiftDto.locationId !== undefined && {
        locationId: updateShiftDto.locationId || null,
      }),
      ...(updateShiftDto.departmentIds !== undefined && {
        departmentIds: updateShiftDto.departmentIds || [],
      }),
      ...(updateShiftDto.designationIds !== undefined && {
        designationIds: updateShiftDto.designationIds || [],
      }),
